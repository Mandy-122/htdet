...
// ============================================================
//
// Uncomment for HLS W8A32 synthesis (INT8 conv weights, FP32 activations):
//typedef ap_int<8>                            wint8_t;   // INT8 conv weight (BN-fused)
// Uncomment for HLS W8A8 synthesis (INT8 weights + INT8 activations):
//typedef ap_fixed<8, 2, AP_RND, AP_SAT>  act8b2_t;  // retina_reg output
//typedef ap_fixed<8, 3, AP_RND, AP_SAT>  act8b3_t;  // conv_proj, small lateral
//typedef ap_fixed<8, 4, AP_RND, AP_SAT>  act8b4_t;  // later-stage expand, FPN
//typedef ap_fixed<8, 5, AP_RND, AP_SAT>  act8b5_t;  // most backbone 1×1 convs
//typedef ap_fixed<8, 6, AP_RND, AP_SAT>  act8b6_t;  // stages 2–4 fusion, retina_cls
//typedef ap_fixed<8, 7, AP_RND, AP_SAT>  act8b7_t;  // conv3_1x1 s0, DW s1.1
//typedef ap_fixed<8, 9, AP_RND, AP_SAT>  act8b9_t;  // DW outliers stages_0/1
