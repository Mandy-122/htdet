# HTDet mobilevit_s + 256-ch FA-FPN (Frequency-Aware FPN)
#
# Backbone : mobilevit_s  (same as 44.12% teacher)
# Neck     : FAFPN, out_channels=256, FA modules after each FPN level
# Head     : RetinaHead, feat_channels=256
# Load from: htdet_mobilevit_finetune_stage2/latest.pth (44.12% mAP)
#            — backbone + FPN + head all load; FA modules init randomly
#
# Novelty claim: FA-FPN > UCA-FPN > plain FPN (44.12%)
#
# Launch:
#   PYTHONPATH=. /workspace/ckarfa/anaconda3/envs/mani/bin/python3.9 \
#     tools/train.py configs/htdet/htdet_s_256_fafpn.py --gpu-id 0
...
work_dir = 'work_dirs/htdet_s_256_fafpn'
auto_resume = False
gpu_ids = [0]
