...
void mbconv_160(
    ...
    static act_t dw_buf[256 * STEM_H * STEM_W];   // dw output buffer
...
void mbconv_80(
    ...
    // Save residual input in case in==out (aliased in-place call)
...
void mobilevit_backbone(
    ...
    // Treat input_t as act_t (both Q8.8, compatible cast)
    ...
    //   TOTAL = 612288
    off += 612288;
    // c2 = [96, 80, 80]  ← FPN input at stride 8 (via 4-view transformer)
