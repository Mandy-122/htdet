/*
 * testbench_t_blk_s3.cpp
 * C-simulation testbench for transformer_blk_s3_top.
 *
 * Tests:
 ...
 *   g++ -std=c++14 -I. -O2 testbench_t_blk_s3.cpp t_blk_s3_top.cpp -lm -o tb_t_blk_s3
 */

#include <iostream>
#include <cstring>
#include <cmath>
#include "t_blk_s3_top.h"
...
static void ref_transformer_blk_s3(
...
int main() {
    std::cout << "=========================================================\n";
    std::cout << "transformer_blk_s3_top  C-simulation testbench\n";
    ...
    transformer_blk_s3_top(in, out, w);
    ...
    transformer_blk_s3_top(in, out, w);
    ref_transformer_blk_s3(in, ref, w);
