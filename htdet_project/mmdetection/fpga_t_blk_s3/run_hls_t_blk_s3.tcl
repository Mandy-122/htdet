...
#
# Outputs:
#   t_blk_s3_prj/t_blk_s3_200MHz/syn/report/transformer_blk_s3_top_csynth.rpt

# ============================================================
# Configuration
# ============================================================
set SRC_DIR  "."
set PRJ_NAME "t_blk_s3_prj"
set SOL_NAME "t_blk_s3_200MHz"
set TOP_FUNC "transformer_blk_s3_top"
...
# 2. Add source files
# ============================================================
add_files "${SRC_DIR}/t_blk_s3_top.cpp" \
    -cflags "-I${SRC_DIR} -std=c++14"

add_files -tb "${SRC_DIR}/testbench_t_blk_s3.cpp" \
    -cflags "-I${SRC_DIR} -std=c++14"
...
puts "==========================================================="
puts "transformer_blk_s3_top synthesis complete."
puts "Report: ${PRJ_NAME}/${SOL_NAME}/syn/report/transformer_blk_s3_top_csynth.rpt"
puts ""
puts "Scaling checklist (edit t_blk_s3_types.h):"
