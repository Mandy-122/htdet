...
#define INPUT_H   320
#define INPUT_W   320
#define IMAGE_ELEMS  (INPUT_C * INPUT_H * INPUT_W)  // 3×320×320 = 307,200
...
#define MVIT_N_S2  ((C2_H / MVIT_PATCH) * (C2_W / MVIT_PATCH))  // 400 for 320 input  (was 1600)
#define MVIT_N_S3  ((C3_H / MVIT_PATCH) * (C3_W / MVIT_PATCH))  // 100 for 320 input  (was 400)
#define MVIT_N_S4  ((C4_H / MVIT_PATCH) * (C4_W / MVIT_PATCH))  // 25  for 320 input  (was 100)
...
// ============================================================
// BACKBONE OUTPUT SPATIAL DIMENSIONS  (320x320 input)
// ============================================================
...
#define P2_H    C1_H    // 80   (INPUT_H/4)
#define P2_W    C1_W    // 80
#define P3_H    C2_H    // 40   (INPUT_H/8)
#define P3_W    C2_W    // 40
#define P4_H    C3_H    // 20   (INPUT_H/16)
#define P4_W    C3_W    // 20
#define P5_H    C4_H    // 10   (INPUT_H/32)
#define P5_W    C4_W    // 10
#define P6_H    (C4_H / 2)  // 5   (INPUT_H/64)
