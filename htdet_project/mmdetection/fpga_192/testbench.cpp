 ...
 * 192-channel FPN+Head variant (mobilevit_s backbone, FPN out=192).
 *
 * Usage:
 ...
 * Weight binary format expected: float32 (weight_t=float)
 */
...
// ============================================================
// Backbone: mobilevit_s, unchanged from 256-ch model
#define BACKBONE_W_ELEMS   4937632
// FPN: lateral(64+96+128+640)*192 + 4*192 + 4*(192*192*9+192) = 1,506,816
#define FPN_W_ELEMS        1506816
// Head stacked convs: 4 layers × 192*(192*9+2) = 1,329,920 per branch
...
int main(int argc, char** argv) {
    std::cout << "==============================================\n";
    std::cout << "HTDet FPGA Testbench (C Simulation) — 192ch\n";
    std::cout << "==============================================\n";
    ...
    std::cout << "Backbone out: C1=["<< C1_CH <<"," << C1_H <<"," << C1_W
              ...
              <<"] C3=["<< C3_CH <<"," << C3_H <<"," << C3_W
              <<"] C4=["<< C4_CH <<"," << C4_H <<"," << C4_W <<"]\n";
    std::cout << "FPN out:      P2=[192,160,160] … P6=[192,10,10]\n";
