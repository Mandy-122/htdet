/*
 * testbench_t_blk_s2.cpp
 * C-simulation testbench for transformer_blk_s2_top.
 *
 * Tests:
 ...
 *   g++ -std=c++14 -I. -O2 testbench_t_blk_s2.cpp t_blk_s2_top.cpp -lm -o tb_t_blk_s2
 */
...
static void ref_transformer_blk_s2(
...
int main() {
    std::cout << "=========================================================\n";
    std::cout << "transformer_blk_s2_top  C-simulation testbench\n";
    ...
    transformer_blk_s2_top(in, out, w);
    ...
    transformer_blk_s2_top(in, out, w);
    ref_transformer_blk_s2(in, ref, w);
